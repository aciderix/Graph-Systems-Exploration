...
La formule unifiée W\_min(m,d) = (m−d)·L(d) − 2m avec
L(d) = ⌈(√(8d+1) − 1)/2⌉ + 2 est vérifiée partout au-dessus
...
\begin{center}
\textbf{L(d) = ⌈(√(8d+1) − 1)/2⌉ + 2}\qquad
\textbf{W\_pred(m,d) = (m−d)·L(d) − 2m}
\end{center}
...
\begin{center}
\fbox{\textbf{1000 / 1000 concordances exactes.}}
\end{center}
